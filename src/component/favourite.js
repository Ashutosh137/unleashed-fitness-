...
export const Favourite = () => {
  ...
  return (
    <div className='rounded'>{favouriteexercise[0] ? <Search exercise={favouriteexercise} n={favouriteexercise.length} /> : <h1 className='text-center text-capitalize bg-light p-5 text-suceess'>add favourite</h1>}</div>
  )
}
