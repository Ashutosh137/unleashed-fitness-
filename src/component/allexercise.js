...
const Allexercise = () => {
    ...
    return (
        <div className='container text-responsive bg-light'>
            ...
            <div className="d-flex justify-content-between">
                ...
                <form className='w-25 text-capitalize rounded ' onSubmit={(e) => {
                    e.preventDefault()
                    ...
                    <div className="d-flex justify-content-center my-3 curser-pointer">
                        ...
                        <button className='btn mx-1 text-capitalize fw-semibold  btn-danger'>submit</button>
                    </div>
                </form>
            </div>
        </div>
