...
const Home = () => {
    ...
    return (
        <>
            <div className="container main rounded my-4 pt-5 text-capitalize">
                ...
                <div className="my-5 m-3">
                    ...
                    <form className='d-flex' onSubmit={fetch}>
                        <input className='w-100 h6 m-auto p-2' type="text" value={search} onChange={(e) => {
                            setsearch(e.target.value);
                        }} placeholder='your search exercise' />
                        <button type='submit' className='btn btn-danger  m-auto p-2'>Search</button>
                    </form>
                </div>
